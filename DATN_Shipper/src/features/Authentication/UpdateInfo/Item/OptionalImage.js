...
export default function OptionalModal(props) {
  const {isModal, close, selectImage, openCamera, imageKey} = props;
  return (
    <BottomModal
      visible={isModal}
      ...
      <ModalContent style={styles.content}>
        <Image style={styles.imgTop} source={images.shape} />
        <TouchableOpacity
        ...
        <TouchableOpacity
          onPress={() => openCamera(imageKey)}
          style={styles.btnOpencamera}>
          <Image style={styles.cameraImg} source={images.camera} />
